...
public class Usuario extends JFrame implements ActionListener {
    ...
    public Usuario() {
        ...
        Titulo = new JLabel("Ingresa tu usuario y contraseña");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == Aceptar) {
            ...
            if (contraseña.equals("123") && usuario.equals("Admin")) {
                dispose();
                 VentanaAdministrador holi = new VentanaAdministrador();
            } else {
                CompararUsuario comp = new CompararUsuario();
                if (comp.buscarUsuarioYContraseña(usuario, contraseña)) {
                    VentanaAdministrador holi = new VentanaAdministrador();
                }
            }
        }
